...
let sampleMessages: [ChatMessage] = [
    ChatMessage(text: "Good morning! Leo arrived happy and full of energy today 🌟", time: "08:32 AM", isFromMe: false),
    ChatMessage(text: "That's lovely to hear! He was excited about painting this morning.", time: "08:35 AM", isFromMe: true),
    ChatMessage(text: "Hi there! Just wanted to let you know that Leo had a great morning. He finished all his fruit snack today!", time: "09:42 AM", isFromMe: false),
    ChatMessage(text: "That's wonderful to hear, thank you Sarah! Did he manage to take his nap at the usual time?", time: "09:45 AM", isFromMe: true),
    ...
    ChatMessage(text: "Leo just woke up from his nap — slept for a full hour 😴 He's in great mood!", time: "12:55 PM", isFromMe: false),
    ...
    ChatMessage(text: "Leo had a wonderful day today! See you soon 👋", time: "02:45 PM", isFromMe: false),
]
